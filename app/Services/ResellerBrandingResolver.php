...
class ResellerBrandingResolver
{
    ...
    public function defaults(): array
    {
        return [
            ...
            'custom_domain' => null,
            'logo_url' => branding_asset_url_or_fallback(Setting::getValue('logo_url'), 'logo'),
            'favicon_url' => branding_asset_url_or_fallback(Setting::getValue('favicon_url'), 'favicon'),
    ...
    public function forReseller(?User $reseller): array
    {
        ...
        $branding = array_merge($this->defaults(), [
            ...
            'favicon_url' => branding_asset_url_or_fallback($stored['favicon_url'] ?? null, 'favicon'),
