...
class SettingController extends Controller
{
    protected array $groups = [
        ...
        'provisioning' => [
            'provisioning_mode', 'auto_provision', 'reseller_auto_provision_hosting', 'shared_hosting_sales_enabled', 'suspend_on_overdue', 'terminate_after_unpaid_months',
        ...
        'notifications' => [
            ...
            'notify_container_backup', 'notify_container_backup_failure',
