...
Route::middleware(['auth', 'skip.verification.if.impersonating'])->group(function () {
    ...
    Route::middleware('customer')->group(function () {
        ...
        Route::post('my/services/{service}/container/initialize-laravel', [App\Http\Controllers\Customer\ContainerController::class, 'initializeLaravel'])->middleware('throttle:10,60')->name('customer.services.container.initialize-laravel');
        Route::post('my/services/{service}/container/clear-app', [App\Http\Controllers\Customer\ContainerController::class, 'clearAppDirectory'])->middleware('throttle:10,60')->name('customer.services.container.clear-app');
        Route::get('my/services/{service}/container/laravel-setup', [App\Http\Controllers\Customer\ContainerController::class, 'laravelSetupStatus'])->middleware('throttle:120,1')->name('customer.services.container.laravel-setup');
