...
Route::middleware(['auth', 'skip.verification.if.impersonating'])->group(function () {
    ...
    Route::middleware(['admin', 'admin.attention.seen'])->group(function () {
        ...
        Route::post('admin/products/{product}/toggle-active', [ProductController::class, 'toggleActive'])->name('admin.products.toggle-active');
        ...
        Route::post('admin/resellers/{user}/wallet-clear', [ResellerController::class, 'clearWallet'])->name('admin.resellers.wallet-clear');
        ...
        Route::post('admin/services/bulk-destroy', [ServiceController::class, 'bulkDestroy'])->name('admin.services.bulk-destroy');
        ...
        Route::get('admin/services/{service}/mail-pull-status', [DirectAdminMailcowMigrationController::class, 'status'])->name('admin.services.mail-pull-status');
        ...
        Route::post('admin/domain-renewals/{renewal}/push-registrar', [DomainRenewalController::class, 'pushToRegistrar'])->name('admin.domain-renewals.push-registrar');
    ...
    Route::middleware(['reseller', 'reseller.billing'])->group(function () {
        ...
        Route::middleware('reseller.limits')->group(function () {
            ...
            Route::get('reseller/domains/{domain}/dns', [ResellerDnsController::class, 'index'])->name('reseller.domains.dns.index');
            Route::post('reseller/domains/{domain}/dns/provision', [ResellerDnsController::class, 'provision'])->middleware('throttle:10,1')->name('reseller.domains.dns.provision');
            Route::post('reseller/domains/{domain}/dns/records', [ResellerDnsController::class, 'addRecord'])->middleware('throttle:30,1')->name('reseller.domains.dns.add-record');
            Route::patch('reseller/domains/{domain}/dns/records/{recordId}', [ResellerDnsController::class, 'updateRecord'])->middleware('throttle:30,1')->name('reseller.domains.dns.update-record');
            Route::delete('reseller/domains/{domain}/dns/records/{recordId}', [ResellerDnsController::class, 'deleteRecord'])->middleware('throttle:30,1')->name('reseller.domains.dns.delete-record');
    ...
    Route::middleware(['customer', 'reseller.customer.catalog'])->group(function () {
        ...
        Route::get('/my/projects/{project}', [App\Http\Controllers\Customer\ServiceController::class, 'showProject'])->name('customer.projects.show');
        ...
        Route::get('my/services/{service}/container/ollama/models', [App\Http\Controllers\Customer\ContainerController::class, 'ollamaModels'])->middleware('throttle:20,1')->name('customer.services.container.ollama.models');
        Route::post('my/services/{service}/container/ollama/chat', [App\Http\Controllers\Customer\ContainerController::class, 'ollamaChat'])->middleware('throttle:20,1')->name('customer.services.container.ollama.chat');
        Route::post('my/services/{service}/container/hermes/ollama', [App\Http\Controllers\Customer\ContainerController::class, 'connectHermesOllama'])->middleware('throttle:5,10')->name('customer.services.container.hermes.ollama.connect');
        ...
        Route::post('my/services/{service}/container/git-repository/cancel', [App\Http\Controllers\Customer\ContainerController::class, 'cancelGitPull'])->middleware('throttle:laravel-container-actions')->name('customer.services.container.git-repository.cancel');
        Route::post('my/services/{service}/container/git-repository/restart', [App\Http\Controllers\Customer\ContainerController::class, 'restartGitPull'])->middleware('throttle:laravel-container-actions')->name('customer.services.container.git-repository.restart');
        ...
        Route::post('my/services/{service}/container/database/import', [App\Http\Controllers\Customer\ContainerController::class, 'databaseImport'])->middleware('throttle:60,1')->name('customer.services.container.database.import');
