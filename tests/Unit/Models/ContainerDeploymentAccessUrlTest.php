...
class ContainerDeploymentAccessUrlTest extends TestCase
{
    ...
    #[Test]
    public function the_node_port_is_only_advertised_for_a_stack_that_still_publishes_publicly(): void
    {
        ...
        $this->assertNull($isolated->getAccessUrl());

        $isolatedWithDomainColumn = $this->deployment([], network_subnet: '10.210.0.0/24', domain: 'legacy.example.com');
        $this->assertSame('https://legacy.example.com', $isolatedWithDomainColumn->getAccessUrl());
    }
