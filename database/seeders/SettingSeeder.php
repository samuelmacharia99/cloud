...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'notify_container_backup_failure', 'value' => 'true', 'description' => 'Telegram only: container backup failure (never email)'],
            ...
            ['key' => 'notify_admin_node_offline', 'value' => 'true', 'description' => 'Telegram only: container node offline (never email)'],
            ...
            ['key' => 'notify_service_provision_failed', 'value' => 'true', 'description' => 'Notify customer when service auto-provisioning fails. Admins receive Telegram only.'],
