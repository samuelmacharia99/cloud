...
class CronJobSeeder extends Seeder
{
    public function run(): void
    {
        $jobs = [
            ...
            [
                'name' => 'Provision Pending Mailcow',
                'description' => 'Retries provisioning for paid email hosting services stuck in pending or failed status.',
                'command' => 'cron:provision-pending-mailcow',
                'schedule' => '*/15 * * * *',
                'enabled' => true,
            ],
            [
                'name' => 'Expire Customer Credits',
                'description' => 'Marks expired customer credit balances as expired.',
                'command' => 'credits:expire',
                'schedule' => '0 1 * * *',
                'enabled' => true,
            ],
            [
                'name' => 'Settle Orphaned Payments',
                'description' => 'Settles completed payments (M-Pesa, Stripe, PayPal) whose invoices were not marked paid.',
                'command' => 'cron:settle-orphaned-payments',
                'schedule' => '*/10 * * * *',
                'enabled' => true,
            ],
            [
