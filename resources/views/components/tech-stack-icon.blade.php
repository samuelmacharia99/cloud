...
{{-- Brand marks from Simple Icons (CC0), colored with official brand hex. --}}
@switch($slug)
    @case('wordpress')
        <svg {{ $attributes->merge(['class' => $class]) }} viewBox="0 0 24 24" fill="#21759B" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    @case('static-site')
        <svg {{ $attributes->merge(['class' => $class]) }} viewBox="0 0 24 24" fill="#E34F26" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z"/>
        </svg>
        @break

    @case('laravel')
        <svg {{ $attributes->merge(['class' => $class]) }} viewBox="0 0 24 24" fill="#FF2D20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    @case('php')
        <svg {{ $attributes->merge(['class' => $class]) }} viewBox="0 0 24 24" fill="#777BB4" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    @case('strapi')
        <svg {{ $attributes->merge(['class' => $class]) }} viewBox="0 0 24 24" fill="#4945FF" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    @case('hermes')
        <svg {{ $attributes->merge(['class' => $class]) }} viewBox="0 0 24 24" fill="#C9A227" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path d="M12 1.4 3.8 5.7v5.4c0 5.7 3.5 9.8 8.2 11.5 4.7-1.7 8.2-5.8 8.2-11.5V5.7L12 1.4zm0 2.2 6.4 3.3v4.2c0 4.5-2.6 7.8-6.4 9.3-3.8-1.5-6.4-4.8-6.4-9.3V6.9L12 3.6zm-2.7 5.1h1.8v2.2h1.8V8.7h1.8v6.6h-1.8v-2.7h-1.8v2.7H9.3V8.7z"/>
        </svg>
        @break

    @case('openclaw')
        <svg {{ $attributes->merge(['class' => $class]) }} viewBox="0 0 24 24" fill="#FF4D1A" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path d="M4.2 8.1c.9-2.6 3.1-4.2 5.6-4.6 1.6-.3 3.3.1 4.6 1.2l1.2-2.2c.3-.5 1-.7 1.5-.4.5.3.7 1 .4 1.5l-2 3.6c.8 1.1 1.2 2.5 1.1 4 0 .4-.1.8-.2 1.2 1.3-.4 2.7-.3 3.9.4 1.1.6 1.9 1.6 2.3 2.8.2.6-.2 1.2-.8 1.4-.6.2-1.2-.2-1.4-.8-.2-.7-.7-1.3-1.3-1.6-.9-.5-1.9-.4-2.7.1.4 1.4.3 2.9-.4 4.2-1.1 2.1-3.3 3.4-5.7 3.4-3.6 0-6.5-2.8-6.5-6.4 0-2.1.9-3.9 2.4-5.1-.3-.9-.4-1.8-.2-2.7zm3.1.8c-.2.6-.2 1.2 0 1.8l.5 1.5-1.4.8c-1 .6-1.6 1.7-1.6 2.9 0 2.2 1.8 3.9 4 3.9 1.5 0 2.8-.8 3.5-2.1.6-1.1.6-2.4.2-3.5l-.4-1.1 1.3-.6c.4-.2.7-.5.8-.9.2-.8 0-1.7-.5-2.4-.6-.8-1.6-1.3-2.6-1.3-1.3 0-2.4.8-2.8 2z"/>
        </svg>
        @break
    ...
    @case('ospos')
        <svg {{ $attributes->merge(['class' => $class]) }} viewBox="0 0 24 24" fill="#1E88E5" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path d="M4 3.5h16a1 1 0 0 1 1 1V9H3V4.5a1 1 0 0 1 1-1zm-1 7h18v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-8zm3 2v2h4v-2H6zm6 0v2h6v-2h-6zm-6 4v2h4v-2H6zm6 0v2h6v-2h-6z"/>
        </svg>
        @break
