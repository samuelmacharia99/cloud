...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 hover:border-slate-300 transition-colors">
            ...
            <p class="text-xs text-slate-500 mt-4">Active accounts</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 hover:border-slate-300 transition-colors">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900 mt-2">{{ $activeServices }}</p>
                </div>
            ...
            <p class="text-xs text-slate-500 mt-4">Running now</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 hover:border-slate-300 transition-colors">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-slate-600">Unpaid Invoices</p>
                    <p class="text-3xl font-bold text-slate-900 mt-2">${{ number_format($unpaidInvoices, 2) }}</p>
                </div>
            ...
            <p class="text-xs text-slate-500 mt-4">Awaiting payment</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 hover:border-slate-300 transition-colors">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900 mt-2">${{ number_format($totalRevenue, 2) }}</p>
                </div>
            ...
            <p class="text-xs text-slate-500 mt-4">All time</p>
        </div>
    </div>
            ...
            @forelse ($recentInvoices as $invoice)
                <div class="p-6 hover:bg-slate-50 transition-colors flex items-center justify-between">
                    ...
                    <div class="text-right">
                        ...
                        <span class="inline-block px-2 py-1 rounded text-xs font-medium {{ $invoice->status === 'paid' ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700' }}">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-6">
        <h2 class="text-lg font-semibold text-slate-900 mb-4">Open Support Tickets</h2>
        <div class="flex items-center justify-center py-8">
            <div class="text-center">
                ...
                <p class="font-medium text-slate-900">{{ $openTickets }} open tickets</p>
