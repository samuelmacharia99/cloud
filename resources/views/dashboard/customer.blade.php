    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                <div class="p-6 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
                    ...
                    <a href="{{ route('customer.payments.index') }}" class="text-xs font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition">View all →</a>
                </div>
                <div class="divide-y divide-slate-200 dark:divide-slate-800">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gradient-to-br from-blue-600 to-blue-700 dark:from-blue-900 dark:to-blue-800 rounded-xl border border-blue-500 dark:border-blue-700 p-6 text-white">
                ...
                <a href="{{ route('customer.tickets.index') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-white hover:bg-blue-50 text-blue-600 font-medium rounded-lg text-sm transition">
