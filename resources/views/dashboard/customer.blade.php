...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <a href="{{ auth()->user()->reseller_id ? route('customer.catalog.index') : route('customer.deploy-service') }}" class="ui-card ui-card-interactive p-4 flex items-center gap-3 group">
            ...
            <x-dashboard-section title="My Services" :href="route('customer.services.index')" action_text="View all">
                ...
                @else
                    <div class="px-6 py-10 text-center">
                        ...
                        <a href="{{ auth()->user()->reseller_id ? route('customer.catalog.index') : route('customer.deploy-service') }}" class="btn-primary btn-sm">Deploy your first app</a>
                    </div>
                @endif
            </x-dashboard-section>
        </div>
