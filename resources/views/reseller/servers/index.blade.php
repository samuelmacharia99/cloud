        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($services as $service)
                    <div class="ui-card p-6 hover:shadow-lg transition">
                        <!-- Status Row -->
                    ...
                    <template x-if="serverType === 'vps'">
                        <div class="space-y-4">
                            @forelse ($vpsProducts as $product)
                                @include('reseller.servers.partials.product-order-card', compact('product', 'currencyCode', 'linuxDistros', 'maxIpCount'))
                            @empty
