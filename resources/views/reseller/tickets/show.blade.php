...
<div class="space-y-6 max-w-4xl">
    ...
    @if (!$ticket->isClosed())
        <form action="{{ route('reseller.tickets.reply', $ticket) }}" method="POST" class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 space-y-4">
            @csrf
