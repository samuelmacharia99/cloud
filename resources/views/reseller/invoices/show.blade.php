            ...
            <div class="border-t border-slate-200 dark:border-slate-700 pt-8">
                ...
                <div class="flex flex-wrap gap-3 mb-6">
                    ...
                    @if(in_array($invoice->status->value, ['unpaid', 'overdue']))
                        <a href="{{ route('reseller.payment.select-method', $invoice) }}" class="inline-flex items-center px-6 py-2 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-lg transition text-sm">
