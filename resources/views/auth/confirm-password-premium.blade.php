...
<div x-data="{ showPassword: false }" class="space-y-7">
    ...
    <div class="text-center text-xs text-slate-600 dark:text-slate-400">
        <p>Forgot your password? <a href="{{ route('password.request') }}" class="text-purple-600 dark:text-purple-400 hover:underline transition font-semibold">Reset it here</a></p>
    </div>
</div>
@endsection
