                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">Port for SSH health monitoring (typically 22). Not the DirectAdmin panel port above.</p>
                            @error('ssh_port')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="nameserver_1" name="nameserver_1" value="{{ old('nameserver_1') }}" placeholder="ns1.example.com" class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm @error('nameserver_1') border-red-500 @enderror" required>
                        ...
                        <div>
                            ...
                            <input type="text" id="nameserver_2" name="nameserver_2" value="{{ old('nameserver_2') }}" placeholder="ns2.example.com" class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm @error('nameserver_2') border-red-500 @enderror">
                            @error('nameserver_2')<p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>@enderror
                        </div>
                        <div>
                            ...
                            <input type="text" id="nameserver_3" name="nameserver_3" value="{{ old('nameserver_3') }}" class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm">
                        </div>
                        <div>
                            ...
                            <input type="text" id="nameserver_4" name="nameserver_4" value="{{ old('nameserver_4') }}" class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm">
                        </div>
                    </div>
                </div>
