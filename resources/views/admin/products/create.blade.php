        ...
        <form method="POST" action="{{ route('admin.products.store') }}" class="space-y-8" x-data="{ name: '{{ old('name') }}', productType: '{{ old('type', '') }}' }" @change="productType = document.getElementById('type').value">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div x-show="productType === 'container_hosting'">
                        ...
                        <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">Leave as “All stacks” for size tiers (Starter / Growth / Pro) that work with any language. Or lock the plan to one stack (e.g. Laravel only).</p>
                ...
                <div class="space-y-6">
                    ...
                    <div x-show="productType !== 'shared_hosting' && productType !== 'container_hosting'" class="pt-4 border-t border-slate-200 dark:border-slate-700">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <span class="absolute left-4 top-2 text-slate-500 dark:text-slate-400 text-sm">$</span>
                                <input type="number" id="wholesale_monthly_price" name="wholesale_monthly_price" value="{{ old('wholesale_monthly_price') }}" placeholder="0.00" step="0.01" min="0" class="w-full pl-7 pr-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm @error('wholesale_monthly_price') border-red-500 @enderror">
                            </div>
            ...
            <div x-show="productType === 'container_hosting'" class="border-t border-slate-200 dark:border-slate-800 pt-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="disk_overage_rate" name="disk_overage_rate" value="{{ old('disk_overage_rate', 0) }}" step="0.01" min="0" class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm @error('disk_overage_rate') border-red-500 @enderror">
            ...
            <div x-show="productType === 'container_hosting'" class="border-t border-slate-200 dark:border-slate-800 pt-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="bandwidth_overage_enabled" value="1" class="w-4 h-4 text-blue-600 rounded" @checked(old('bandwidth_overage_enabled') === '1' || old('bandwidth_overage_enabled') === true)>
                    ...
                    <div>
                        ...
                        <input type="number" id="bandwidth_overage_rate" name="bandwidth_overage_rate" value="{{ old('bandwidth_overage_rate', 0) }}" step="0.0001" min="0" class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm @error('bandwidth_overage_rate') border-red-500 @enderror">
            ...
            @include('admin.products.partials.server-configuration', ['limits' => [], 'productType' => old('type', 'vps')])
