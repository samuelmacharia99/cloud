        ...
        <div class="flex flex-col gap-4">
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('admin.products.index', ['type' => 'domain']) }}" class="px-4 py-2 rounded-lg font-medium text-sm transition {{ request('type') === 'domain' ? 'bg-blue-600 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700' }}">
                        Domain
                    </a>
                    ...
                    <a href="{{ route('admin.products.index', ['type' => 'sms_bundle']) }}" class="px-4 py-2 rounded-lg font-medium text-sm transition {{ request('type') === 'sms_bundle' ? 'bg-blue-600 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700' }}">
                        SMS Bundle
                    </a>
                    <a href="{{ route('admin.products.index', ['type' => 'hotspot_plan']) }}" class="px-4 py-2 rounded-lg font-medium text-sm transition {{ request('type') === 'hotspot_plan' ? 'bg-blue-600 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700' }}">
                        Hotspot Plan
                    </a>
                </div>
            </div>
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-400">
                                @if ($product->monthly_price && $product->yearly_price)
                                    ${{ number_format($product->monthly_price, 2) }} / mo, ${{ number_format($product->yearly_price, 2) }} / yr
