    ...
    <form method="POST" action="{{ route('admin.container-templates.store') }}" class="ui-card p-6 space-y-6">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div>
                ...
                <input type="number" name="health_check_timeout_seconds" value="{{ old('health_check_timeout_seconds', 120) }}" min="30" max="1800" class="{{ $inputClass }} @error('health_check_timeout_seconds') border-red-500 @enderror" required>
