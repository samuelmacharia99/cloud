...
<div class="space-y-6">
    ...
    <!-- Filters -->
    <form method="GET" class="ui-card p-6 space-y-4">
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <form action="{{ route('admin.domains.destroy', $domain) }}" method="POST" style="display: inline;" data-confirm='Are you sure you want to delete this domain? This action cannot be undone.'>
                                        @csrf
                                        @method('DELETE')
