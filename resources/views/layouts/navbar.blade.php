<header class="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 sm:px-6 min-w-0">
    ...
    <div class="flex items-center gap-2 sm:gap-4 shrink-0">
        <button type="button" class="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg" @click="dark = !dark; localStorage.setItem('theme', dark ? 'dark' : 'light')" aria-label="Toggle dark mode">
