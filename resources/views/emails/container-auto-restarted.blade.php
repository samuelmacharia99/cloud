<h2 style="margin:0 0 12px 0;">Application Auto-Restarted</h2>

<p>Your application service <strong>{{ $service->name }}</strong> experienced a temporary failure but was automatically restarted by our monitoring system.</p>
