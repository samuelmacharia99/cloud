...
<p><a href="{{ customer_portal_route($ticket->user, 'customer.tickets.show', $ticket, $emailBranding['portal_url'] ?? null) }}" style="display: inline-block; padding: 10px 20px; background-color: #2563eb; color: white; text-decoration: none; border-radius: 4px; margin-top: 10px;">View Your Ticket</a></p>
