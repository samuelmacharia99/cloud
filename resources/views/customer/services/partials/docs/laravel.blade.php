    ...
    <div class="grid md:grid-cols-2 gap-6">
        <div class="rounded-xl border border-slate-200 dark:border-slate-700 p-6 space-y-3">
            ...
            <ul class="text-sm text-slate-600 dark:text-slate-300 space-y-2">
                ...
                <li>For <strong>private GitHub repositories</strong>, save a Personal Access Token on the GitHub tab (Contents: Read). Optional Composer token for private packages.</li>
