    ...
    <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="rounded-xl border border-slate-200 dark:border-slate-700 p-6 space-y-3">
            ...
            <ul class="text-sm text-slate-600 dark:text-slate-300 space-y-2">
                ...
                <li>For Next.js/Nuxt apps, Talksasa prefers <code class="font-mono text-xs">npm ci --include=dev</code> (falls back to <code class="font-mono text-xs">npm install --include=dev</code> if the lockfile is stale) → prepare → <code class="font-mono text-xs">node node_modules/next/dist/bin/next build</code> (Next) / <code class="font-mono text-xs">npm run build</code> after each Git pull when a framework build is detected.</li>
