<section class="space-y-6">
    ...
    <div class="rounded-xl border border-amber-200 dark:border-amber-800 bg-amber-50/60 dark:bg-amber-950/20 p-6 space-y-3">
        ...
        <ul class="text-sm text-amber-900/90 dark:text-amber-100/90 space-y-2">
            <li><strong>Bundle install fails</strong> — Native gem extensions may need build tools; simplify gems or use precompiled alternatives. Bundle failures fail the Git pull so the app is not left half-updated.</li>
