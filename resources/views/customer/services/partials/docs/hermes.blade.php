<section class="space-y-6">
    ...
    <div class="rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50/80 dark:bg-slate-900/40 p-6">
        ...
        <ol class="mt-4 space-y-3 text-sm text-slate-700 dark:text-slate-300 list-decimal list-inside">
            <li>Deploy Ollama into the same project and pull a 64K-context model. Mistral 7B maxes out at 32K — Hermes will reject it. On Ollama Terminal run <code class="font-mono text-xs">ollama pull llama3.1:8b</code> (about 4.9 GB) and wait until it finishes.</li>
