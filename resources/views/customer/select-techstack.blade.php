...
<div class="space-y-6">
    ...
    <form action="{{ route('customer.confirm-techstack') }}" method="POST" class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-8" x-data="techstackSelector()">
        ...
        <div class="mt-8 flex gap-4">
            ...
            <a href="{{ route('customer.deploy-service') }}" class="px-6 py-3 border-2 border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 rounded-lg font-semibold hover:bg-slate-100 dark:hover:bg-slate-800 transition">
                Browse All Services
            </a>
        </div>
    </form>
