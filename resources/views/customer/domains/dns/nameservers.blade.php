            ...
            <div class="ui-card p-6">
                ...
                <form action="{{ route('customer.domains.nameservers', $domain) }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="nameserver_2" value="{{ $domain->nameserver_2 ?? '' }}" placeholder="e.g., ns2.example.com" class="w-full px-4 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-white" required>
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Required — the registry needs at least two unique nameservers</p>
                    </div>
