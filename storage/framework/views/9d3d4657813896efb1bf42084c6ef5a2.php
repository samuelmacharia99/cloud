...
<div class="max-w-2xl mx-auto">
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-xl">
        ...
        <div class="p-6 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('customer.domains.index')); ?>" class="text-slate-500 hover:text-slate-700 dark:hover:text-slate-300">
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Register New Domain -->
                <a href="<?php echo e(route('customer.select-techstack')); ?>" class="cursor-pointer p-6 border-2 border-slate-200 dark:border-slate-700 rounded-xl hover:border-blue-500 dark:hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/20 transition block">
                ...
                <!-- Transfer Domain -->
                <a href="<?php echo e(route('customer.domains.transfer-form')); ?>" class="cursor-pointer p-6 border-2 border-slate-200 dark:border-slate-700 rounded-xl hover:border-emerald-500 dark:hover:border-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/20 transition block">
        ...
        <div class="p-6 border-t border-slate-200 dark:border-slate-800 flex items-center justify-end gap-3">
            <a href="<?php echo e(route('customer.domains.index')); ?>" class="px-6 py-2 text-slate-700 dark:text-slate-300 font-medium hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition">
                Cancel
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/zumi/php/road-map/talksasa-cloud/resources/views/customer/domains/add-modal.blade.php ENDPATH**/ ?>