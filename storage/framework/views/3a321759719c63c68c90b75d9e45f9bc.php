...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['label', 'name', 'options' => [], 'value' => null, 'placeholder' => 'Select an option...', 'required' => false, 'disabled' => false, 'help' => null, 'error' => null]));
...
foreach (array_filter((['label', 'name', 'options' => [], 'value' => null, 'placeholder' => 'Select an option...', 'required' => false, 'disabled' => false, 'help' => null, 'error' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="space-y-2">
    ...
    >
        ...
        <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($key); ?>" <?php if(old($name, $value) == $key): ?> selected <?php endif; ?>>
                <?php echo e($label); ?>
