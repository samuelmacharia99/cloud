...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-slate-600 dark:text-slate-400 mt-1">Configure a new server or container host.</p>
    </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="e.g. US-East-01" class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="container_host" <?php if(old('type') === 'container_host'): echo 'selected'; endif; ?>>Container Host</option>
                            <option value="load_balancer" <?php if(old('type') === 'load_balancer'): echo 'selected'; endif; ?>>Load Balancer</option>
                            <option value="database_server" <?php if(old('type') === 'database_server'): echo 'selected'; endif; ?>>Database Server</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="hostname" name="hostname" value="<?php echo e(old('hostname')); ?>" placeholder="server01.internal" class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm <?php $__errorArgs = ['hostname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                    ...
                    <option value="online" <?php if(old('status') === 'online'): echo 'selected'; endif; ?>>Online</option>
                    <option value="offline" <?php if(old('status') === 'offline'): echo 'selected'; endif; ?>>Offline</option>
                    <option value="degraded" <?php if(old('status') === 'degraded'): echo 'selected'; endif; ?>>Degraded</option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-end">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="verify_ssl" value="1" class="w-4 h-4 text-blue-600 rounded" <?php if(old('verify_ssl') === '1' || old('verify_ssl') === true): echo 'checked'; endif; ?>>
