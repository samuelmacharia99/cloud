<?php $__env->startSection('title', 'Reseller Dashboard'); ?>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900 dark:text-white mt-2"><?php echo e($managedCustomers->count()); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-emerald-600 dark:text-emerald-400 mt-2">$<?php echo e(number_format($totalRevenue, 2)); ?></p>
                </div>
                <div class="w-12 h-12 rounded-lg bg-emerald-100 dark:bg-emerald-950 flex items-center justify-center">
                    <svg class="w-6 h-6 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-purple-600 dark:text-purple-400 mt-2">$<?php echo e(number_format($totalCommission, 2)); ?></p>
                </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                <div class="p-6 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
                    ...
                    <span class="text-sm font-medium text-slate-600 dark:text-slate-400"><?php echo e($totalServices); ?> total</span>
                </div>
                <?php if($managedServices->count() > 0): ?>
                    <div class="divide-y divide-slate-200 dark:divide-slate-800">
                        <?php $__currentLoopData = $managedServices->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                                <div class="flex items-center justify-between">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-slate-600 dark:text-slate-400 mt-1">Customer: <?php echo e($service->user?->name ?? 'N/A'); ?></p>
                                    </div>
                                    <div class="flex items-center gap-3">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($service->status === 'active' ? 'bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300' : ($service->status === 'suspended' ? 'bg-amber-100 dark:bg-amber-950 text-amber-700 dark:text-amber-300' : 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-400')); ?>">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                ...
                <?php if($recentInvoices->count() > 0): ?>
                    <div class="divide-y divide-slate-200 dark:divide-slate-800">
                        <?php $__currentLoopData = $recentInvoices->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors flex items-center justify-between">
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs text-slate-600 dark:text-slate-400 mt-1"><?php echo e($invoice->user?->name ?? 'N/A'); ?></p>
                                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 rounded-xl border border-purple-200 dark:border-purple-800 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?php echo e(route('reseller.packages.index')); ?>" class="text-xs text-purple-600 dark:text-purple-400 hover:underline font-medium">Manage</a>
                </div>
                <?php if($resellerPackage): ?>
                    <p class="text-lg font-bold text-purple-700 dark:text-purple-300"><?php echo e($resellerPackage->name); ?></p>
                    <p class="text-xs text-slate-500 dark:text-slate-400 mb-4"><?php echo e(ucfirst($resellerPackage->billing_cycle)); ?></p>
                    <!-- Service Slots Usage -->
                    <div class="mb-4">
                        <div class="flex justify-between text-xs text-slate-600 dark:text-slate-400 mb-1">
                            <span>Service Slots</span>
                            <span><?php echo e($activeServices); ?> / <?php echo e($resellerPackage->storage_space); ?></span>
                        </div>
                        <?php
                        ...
                        <div class="w-full h-2 bg-slate-300 dark:bg-slate-700 rounded-full overflow-hidden">
                            <div class="<?php echo e($serviceColor); ?> h-2 rounded-full transition-all" style="width: <?php echo e($servicePct); ?>%"></div>
                        </div>
                    </div>
                    <!-- Customers Usage -->
                    <div>
                        <div class="flex justify-between text-xs text-slate-600 dark:text-slate-400 mb-1">
                            <span>Customers</span>
                            <span><?php echo e($managedCustomers->count()); ?> / <?php echo e($resellerPackage->max_users); ?></span>
                        </div>
                        <?php
                        ...
                        ?>
                        <div class="w-full h-2 bg-slate-300 dark:bg-slate-700 rounded-full overflow-hidden">
                            <div class="<?php echo e($customerColor); ?> h-2 rounded-full transition-all" style="width: <?php echo e($customerPct); ?>%"></div>
                        </div>
                    </div>
                <?php else: ?>
                    <p class="text-sm text-amber-700 dark:text-amber-400 font-medium mb-4">No active plan</p>
                    <a href="<?php echo e(route('reseller.packages.index')); ?>" class="w-full block text-center px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-sm font-medium transition-colors">
                        Choose a Package
                    </a>
                <?php endif; ?>
            </div>
            ...
            <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                ...
                <?php if($managedCustomers->count() > 0): ?>
                    <div class="divide-y divide-slate-200 dark:divide-slate-800">
                        <?php $__currentLoopData = $managedCustomers->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                                <p class="font-medium text-sm text-slate-900 dark:text-white"><?php echo e($customer->name); ?></p>
                                <p class="text-xs text-slate-600 dark:text-slate-400 mt-1"><?php echo e($customer->email); ?></p>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php else: ?>
            ...
            <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-semibold text-emerald-600 dark:text-emerald-400"><?php echo e($activeServices); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-slate-600 dark:text-slate-400">Suspended</span>
                        <span class="font-semibold text-amber-600 dark:text-amber-400"><?php echo e($suspendedServices); ?></span>
                    </div>
                    <div class="flex items-center justify-between pt-3 border-t border-slate-200 dark:border-slate-700">
                        ...
                        <span class="font-semibold text-slate-900 dark:text-white"><?php echo e($totalServices); ?></span>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/zumi/php/road-map/talksasa-cloud/resources/views/dashboard/reseller.blade.php ENDPATH**/ ?>