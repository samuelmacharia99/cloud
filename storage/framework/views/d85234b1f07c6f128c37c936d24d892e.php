        ...
        <?php if(auth()->guard()->check()): ?>
            <div class="flex items-center gap-3 text-sm">
                <div class="text-right">
                    <p class="font-medium text-slate-900 dark:text-white"><?php echo e(auth()->user()->name); ?></p>
...
<?php /**PATH /home/zumi/php/road-map/talksasa-cloud/resources/views/layouts/navbar.blade.php ENDPATH**/ ?>