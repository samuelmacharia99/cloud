...
<div class="space-y-6">
    <div>
        ...
        <p class="text-slate-600 dark:text-slate-400 mt-1">Manage customer support requests.</p>
    </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-12 text-center">
        ...
        <p class="text-slate-600 dark:text-slate-400">Support tickets management coming soon</p>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/zumi/php/road-map/talksasa-cloud/resources/views/admin/tickets/index.blade.php ENDPATH**/ ?>