                    ...
                    <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                        <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                                <td class="px-6 py-4 text-sm font-medium text-slate-900 dark:text-white"><?php echo e($invoice->invoice_number); ?></td>
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-slate-900 dark:text-white text-right">$<?php echo e(number_format($invoice->total, 2)); ?></td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="<?php echo e(route('customer.invoices.show', $invoice)); ?>" class="px-3 py-1.5 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition">
                                        View
                                    </a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/zumi/php/road-map/talksasa-cloud/resources/views/customer/invoices/index.blade.php ENDPATH**/ ?>