...
<head>
    ...
    <title><?php echo e(config('app.name', 'Talksasa Cloud')); ?> — Cloud Hosting Platform</title>
    ...
    <nav class="fixed w-full top-0 z-50 bg-[#0F172A]/90 backdrop-blur-lg border-b border-[rgba(0,217,255,0.1)]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="<?php echo e(route('login')); ?>" class="hidden sm:inline nav-link">Login</a>
                <a href="<?php echo e(route('register')); ?>" class="btn-cyan text-xs sm:text-sm">Get Started</a>
            </div>
        </div>
    </nav>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn-outline text-center">
                            Deploy A Copy
                        </a>
                    </div>
            ...
            <?php if($packages->count() > 0): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div class="card-dark p-8 <?php echo e($isMostPopular ? 'pricing-highlight relative' : ''); ?>">
                            <?php if($isMostPopular): ?>
                                <div class="absolute -top-4 left-1/2 transform -translate-x-1/2">
                                    <span class="badge-cyan">Most Popular</span>
                                </div>
                            <?php endif; ?>
                            <h3 class="text-2xl font-bold text-white mb-2 <?php echo e($isMostPopular ? 'mt-4' : ''); ?>"><?php echo e($package->name); ?></h3>
                            <p class="text-slate-400 text-sm mb-6"><?php echo e($package->description); ?></p>
                            <div class="mb-6">
                                <span class="text-4xl font-bold <?php echo e($isMostPopular ? 'text-gradient' : 'text-white'); ?>">KES <?php echo e(number_format($package->monthly_price, 0)); ?></span>
                                <span class="text-slate-400 text-sm">/month</span>
                            </div>
                            <button class="<?php echo e($isMostPopular ? 'btn-cyan' : 'btn-outline'); ?> w-full mb-8">Get Started</button>
        ...
        function domainSearchApp() {
            return {
                ...
                async searchDomain() {
                    ...
                    try {
                        const url = new URL('<?php echo e(route('domains.search.public')); ?>', window.location.origin);
                ...
                async goToCheckout() {
                    ...
                    try {
                        ...
                        const response = await fetch('<?php echo e(route("checkout.sync-cart")); ?>', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                        ...
                        if (response.ok) {
                            ...
                            setTimeout(() => {
                                window.location.href = '<?php echo e(route("checkout.show.public")); ?>';
                            }, 500);
                        } else {
...
<?php /**PATH /home/zumi/php/road-map/talksasa-cloud/resources/views/welcome.blade.php ENDPATH**/ ?>