...
<head>
    ...
    <title><?php echo e(config('app.name', 'Talksasa Cloud')); ?> — Modern Web Hosting Platform</title>
...
<body class="antialiased bg-white">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        <a href="<?php echo e(route('register')); ?>" class="px-8 py-3.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg font-semibold hover:shadow-xl transition transform hover:-translate-y-0.5">
                            Start Free Trial
                        </a>
    ...
    <section id="domain" class="py-16 px-4 sm:px-6 lg:px-8 bg-white border-t border-gray-100">
        <div class="max-w-2xl mx-auto">
            ...
            <form action="<?php echo e(route('domains.search.public')); ?>" method="GET" class="flex gap-2">
    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <div class="flex gap-4 justify-center">
                <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg font-semibold hover:shadow-lg transition transform hover:-translate-y-0.5">
                    Create Free Account
                </a>
