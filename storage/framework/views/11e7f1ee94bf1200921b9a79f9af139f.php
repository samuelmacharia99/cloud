...
<head>
    ...
    <title>Find Your Domain — <?php echo e(config('app.name', 'Talksasa Cloud')); ?></title>
        ...
        function domainSearch() {
            return {
                ...
                async searchDomain() {
                    ...
                    try {
                        const response = await fetch(`<?php echo e(route('domains.search.public')); ?>?q=${encodeURIComponent(this.searchQuery)}`);
