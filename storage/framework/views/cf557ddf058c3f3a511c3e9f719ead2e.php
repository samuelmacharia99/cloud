...
<div class="space-y-8">
    ...
    <div class="bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-700 dark:to-teal-700 rounded-xl p-8 text-white">
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('customer.select-techstack')); ?>" class="px-6 py-3 bg-white hover:bg-emerald-50 text-emerald-600 font-semibold rounded-lg transition flex items-center gap-2">
