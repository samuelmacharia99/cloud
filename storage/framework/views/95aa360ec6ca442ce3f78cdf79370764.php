...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" x-data="{ dark: localStorage.getItem('theme') === 'dark' || (!localStorage.getItem('theme') && window.matchMedia('(prefers-color-scheme: dark)').matches) }" :class="{ 'dark': dark }">
    <head>
        ...
        <title><?php echo $__env->yieldContent('title', 'Sign In'); ?> — <?php echo e(config('app.name', 'Talksasa Cloud')); ?></title>
        ...
        <div class="min-h-screen flex">
            ...
            <div class="hidden lg:flex lg:w-5/12 bg-gradient-to-br from-blue-600 to-blue-800 text-white flex-col justify-between p-12">
                ...
                <div class="text-xs text-blue-100">
                    <p>© <?php echo e(date('Y')); ?> Talksasa Cloud. All rights reserved.</p>
                </div>
            </div>
...
<?php /**PATH /home/zumi/php/road-map/talksasa-cloud/resources/views/layouts/guest.blade.php ENDPATH**/ ?>