...
<div class="space-y-6" x-data="techstackSelector()" @keydown.escape="showDatabaseModal = false">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button
                type="button"
                @click="selectLanguageAndShowModal(<?php echo e($language->id); ?>)"
            ...
            >
                <div class="flex items-start justify-between mb-2">
                    ...
                    <svg x-show="selectedLanguage.id === <?php echo e($language->id); ?>" class="w-5 h-5 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
