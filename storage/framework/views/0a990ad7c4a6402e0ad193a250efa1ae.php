...
<div class="flex items-center gap-2 text-sm">
    ...
    <a href="<?php echo e(route('admin.products.show', $product)); ?>" class="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white"><?php echo e($product->name); ?></a>
    <span class="text-slate-400 dark:text-slate-600">/</span>
...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-8">
        <form method="POST" action="<?php echo e(route('admin.products.update', $product)); ?>" class="space-y-8">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="<?php echo e(old('name', $product->name)); ?>" placeholder="Shared Hosting Plan" class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" name="slug" value="<?php echo e(old('slug', $product->slug)); ?>" placeholder="shared-hosting-plan" class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm <?php $__errorArgs = ['slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="shared_hosting" <?php if(old('type', $product->type) === 'shared_hosting'): echo 'selected'; endif; ?>>Shared Hosting</option>
                            <option value="container_hosting" <?php if(old('type', $product->type) === 'container_hosting'): echo 'selected'; endif; ?>>Container Hosting</option>
                            <option value="domain" <?php if(old('type', $product->type) === 'domain'): echo 'selected'; endif; ?>>Domain</option>
                            <option value="ssl" <?php if(old('type', $product->type) === 'ssl'): echo 'selected'; endif; ?>>SSL Certificate</option>
                            <option value="email_hosting" <?php if(old('type', $product->type) === 'email_hosting'): echo 'selected'; endif; ?>>Email Hosting</option>
                            <option value="sms_bundle" <?php if(old('type', $product->type) === 'sms_bundle'): echo 'selected'; endif; ?>>SMS Bundle</option>
                            <option value="hotspot_plan" <?php if(old('type', $product->type) === 'hotspot_plan'): echo 'selected'; endif; ?>>Hotspot Plan</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="is_active" value="1" class="w-4 h-4 text-blue-600 rounded" <?php if(old('is_active', $product->is_active) === '1' || old('is_active', $product->is_active) === 1): echo 'checked'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-4 top-2 text-slate-500 dark:text-slate-400 text-sm">$</span>
                            <input type="number" id="yearly_price" name="yearly_price" value="<?php echo e(old('yearly_price', $product->yearly_price)); ?>" placeholder="0.00" step="0.01" min="0" class="w-full pl-7 pr-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm <?php $__errorArgs = ['yearly_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-4 top-2 text-slate-500 dark:text-slate-400 text-sm">$</span>
                            <input type="number" id="setup_fee" name="setup_fee" value="<?php echo e(old('setup_fee', $product->setup_fee)); ?>" placeholder="0.00" step="0.01" min="0" class="w-full pl-7 pr-4 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-slate-900 dark:text-white text-sm <?php $__errorArgs = ['setup_fee'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="featured" value="1" class="w-4 h-4 text-blue-600 rounded" <?php if(old('featured', $product->featured) === '1' || old('featured', $product->featured) === 1): echo 'checked'; endif; ?>>
                            <span class="text-sm text-slate-700 dark:text-slate-300">Featured Product</span>
                        </label>
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="visible_to_resellers" value="1" class="w-4 h-4 text-blue-600 rounded" <?php if(old('visible_to_resellers', $product->visible_to_resellers) === '1' || old('visible_to_resellers', $product->visible_to_resellers) === 1): echo 'checked'; endif; ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/zumi/php/road-map/talksasa-cloud/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>