        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
            <div class="p-6 border-b border-slate-200 dark:border-slate-800">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('services.index')); ?>" class="text-xs font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">View all →</a>
                </div>
            </div>
            <div class="divide-y divide-slate-200 dark:divide-slate-800">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
            <div class="p-6 border-b border-slate-200 dark:border-slate-800">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('payments.index')); ?>" class="text-xs font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">View all →</a>
                </div>
            </div>
            <div class="divide-y divide-slate-200 dark:divide-slate-800">
                    ...
                    <div class="p-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                        <div class="flex items-center justify-between gap-3">
                            <div>
                                ...
                                <p class="text-xs text-slate-600 dark:text-slate-400"><?php echo e($payment->gateway); ?></p>
                            </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
            <div class="p-6 border-b border-slate-200 dark:border-slate-800">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('invoices.index')); ?>" class="text-xs font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">View all →</a>
                </div>
            </div>
            <div class="divide-y divide-slate-200 dark:divide-slate-800">
                    ...
                    <div class="p-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                        <div class="flex items-center justify-between gap-3">
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-slate-600 dark:text-slate-400">$<?php echo e(number_format($product->price, 2)); ?></p>
                            </div>
                            <div class="text-right">
