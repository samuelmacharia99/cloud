...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="domain" <?php if(old('type') === 'domain'): echo 'selected'; endif; ?>>Domain</option>
                            ...
                            <option value="sms_bundle" <?php if(old('type') === 'sms_bundle'): echo 'selected'; endif; ?>>SMS Bundle</option>
                            <option value="hotspot_plan" <?php if(old('type') === 'hotspot_plan'): echo 'selected'; endif; ?>>Hotspot Plan</option>
                        </select>
