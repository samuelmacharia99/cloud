<?php $__env->startSection('title', 'Transfer Domain'); ?>

<?php $__env->startSection('breadcrumb'); ?>
<div class="flex items-center gap-2">
    <a href="<?php echo e(route('customer.domains.index')); ?>" class="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white">
        Domains
    </a>
...
document.getElementById('transferForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('<?php echo e(route("customer.domains.process-transfer")); ?>', {
            method: 'POST',
            headers: {
        ...
        if (data.success) {
            ...
            if (data.redirect) {
                ...
                window.location.href = '<?php echo e(route("customer.domains.index")); ?>?success=' + encodeURIComponent(data.message);
            }
        } else {
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/zumi/php/road-map/talksasa-cloud/resources/views/customer/domains/transfer-form.blade.php ENDPATH**/ ?>